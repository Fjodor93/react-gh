...
function Contentmiddle(){
    return(
        <div className="contentmiddle">
            <Link to="solarium" className="contentbox" style={{color: 'inherit', textDecoration: 'none' }}>
                <h2 className='contenthead'>Våra Solariebäddar</h2>
                <img className='contenticon' src={sunbed} alt='Sunbed icon'/>
            </Link>
            <Link to="produkter" className="contentbox" style={{color: 'inherit',  textDecoration: 'none' }}>
